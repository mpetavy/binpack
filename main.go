...
func run() error {
	...
	common.Ignore(fmt.Fprintf(goFile, fmt.Sprintf("}\n")))
	common.Ignore(fmt.Fprintf(goFile, fmt.Sprintf("\n")))
	common.Ignore(fmt.Fprintf(goFile, fmt.Sprintf("func FindPack(path string) *%sFile {\n", strings.Title(*variablePrefix))))
	common.Ignore(fmt.Fprintf(goFile, fmt.Sprintf("	common.DebugFunc(path)\n")))
	common.Ignore(fmt.Fprintf(goFile, fmt.Sprintf("\n")))
	common.Ignore(fmt.Fprintf(goFile, fmt.Sprintf("	for _, file := range %sFiles {\n", strings.Title(*variablePrefix))))
	common.Ignore(fmt.Fprintf(goFile, fmt.Sprintf("		if file.File == path {\n")))
	common.Ignore(fmt.Fprintf(goFile, fmt.Sprintf("\n")))
	common.Ignore(fmt.Fprintf(goFile, fmt.Sprintf("			return &file\n")))
	common.Ignore(fmt.Fprintf(goFile, fmt.Sprintf("		}\n")))
	common.Ignore(fmt.Fprintf(goFile, fmt.Sprintf("	}\n")))
	common.Ignore(fmt.Fprintf(goFile, fmt.Sprintf("\n")))
	common.Ignore(fmt.Fprintf(goFile, fmt.Sprintf("	return nil\n")))
	common.Ignore(fmt.Fprintf(goFile, fmt.Sprintf("}\n")))
	common.Ignore(fmt.Fprintf(goFile, fmt.Sprintf("\n")))
	common.Ignore(fmt.Fprintf(goFile, fmt.Sprintf("func Unpack(path string) ([]byte, error) {\n")))
	common.Ignore(fmt.Fprintf(goFile, fmt.Sprintf("	common.DebugFunc(\"Unpack %s\", path)\n", "%%s")))
	common.Ignore(fmt.Fprintf(goFile, fmt.Sprintf("\n")))
	common.Ignore(fmt.Fprintf(goFile, fmt.Sprintf("	file := FindPack(path)\n")))
	common.Ignore(fmt.Fprintf(goFile, fmt.Sprintf("\n")))
	common.Ignore(fmt.Fprintf(goFile, fmt.Sprintf("	if file != nil {\n")))
	common.Ignore(fmt.Fprintf(goFile, fmt.Sprintf("		return file.Unpack()\n")))
	common.Ignore(fmt.Fprintf(goFile, fmt.Sprintf("	}\n")))
	common.Ignore(fmt.Fprintf(goFile, fmt.Sprintf("	\n")))
	common.Ignore(fmt.Fprintf(goFile, fmt.Sprintf("	return nil, fmt.Errorf(\"unknown file: %s\")\n", "%%s")))
	common.Ignore(fmt.Fprintf(goFile, fmt.Sprintf("}\n")))
	common.Ignore(fmt.Fprintf(goFile, fmt.Sprintf("\n")))
