...
func run() error {
	...
	common.Ignore(fmt.Fprintf(goFile, fmt.Sprintf("    ba,err := ioutil.ReadFile(this.File)\n")))
	common.Ignore(fmt.Fprintf(goFile, fmt.Sprintf("\n")))
	...
	common.Ignore(fmt.Fprintf(goFile, fmt.Sprintf("	}\n")))
	common.Ignore(fmt.Fprintf(goFile, fmt.Sprintf("\n")))
	common.Ignore(fmt.Fprintf(goFile, fmt.Sprintf("	err = ioutil.WriteFile(fileName, ba, common.FileFileMode)\n")))
	common.Ignore(fmt.Fprintf(goFile, fmt.Sprintf("	if common.Error(err) {\n")))
	common.Ignore(fmt.Fprintf(goFile, fmt.Sprintf("		return err\n")))
	common.Ignore(fmt.Fprintf(goFile, fmt.Sprintf("	}\n")))
	common.Ignore(fmt.Fprintf(goFile, fmt.Sprintf("\n")))
	...
	common.Ignore(fmt.Fprintf(goFile, fmt.Sprintf("\n")))
	common.Ignore(fmt.Fprintf(goFile, fmt.Sprintf("			if !b {\n")))
	common.Ignore(fmt.Fprintf(goFile, fmt.Sprintf("				err = os.MkdirAll(path, common.DirFileMode)\n")))
	common.Ignore(fmt.Fprintf(goFile, fmt.Sprintf("				if common.Error(err) {\n")))
	common.Ignore(fmt.Fprintf(goFile, fmt.Sprintf("					return err\n")))
	common.Ignore(fmt.Fprintf(goFile, fmt.Sprintf("				}\n")))
	common.Ignore(fmt.Fprintf(goFile, fmt.Sprintf("			}\n")))
